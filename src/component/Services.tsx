        ...
        services: [
            {
                ...
                info: "Cockatiels are awesome pets, but their one downfall is the fact that they poop everywhere"
            },
            {
                icon: <FaHiking />,
            ...
            },
            {
                icon: <FaBeer />,
                title: "Free Zone",
                info: " There are many variations of passages of Lorem Ipsum available, but the majority form."
            },
        ]
    }
